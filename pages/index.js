    ...
    <>
      <section className={classnames(styles.section)}>
        ...
        <div className={styles['section-inner']}>
          <div className={styles['section-inner-wrap']}>
          ...
          <video autoPlay muted loop width="50%" className={styles['video']}>
      ...
      <section className={classnames(styles.section, styles.roadmap)}>
        ...
        <div className={styles['roadmap-inner']}>
          <div className={styles['roadmap-inner-wrap']}>
            <img src="/cards-1.png" />
            <div><h2>Holding dragons gives you exposure to the revenue generated by the Xin Labs software suite.</h2>
              <h3>The next generation of the Xin Labs software is launching very soon, more information on how we will reward our most loyal holders is just around the corner - watch this space!”
              </h3><br />
              <div className={styles['roadmap-inner-bwrap']}>
                <a href="https://magiceden.io/marketplace/xin_dragons" className={styles['me']} target="_blank" rel="noreferrer">Buy Gen1 on ME</a>
                <a href="https://magiceden.io/marketplace/xin_dragons_gen_2" className={styles['me']} target="_blank" rel="noreferrer">Buy Gen2 on ME</a>
                <a href="https://www.tensor.trade/trade/xin_dragons" className={styles['te']} target="_blank" rel="noreferrer">Buy Gen1 on Tensor</a>
                <a href="https://www.tensor.trade/trade/xin_dragons_gen_2" className={styles['te']} target="_blank" rel="noreferrer">Buy Gen2 on Tensor</a>
        ...
        <section className={styles.section}>
          ...
          <div className={styles['section-inner']}>
            ...
            <div className={styles.team}>
              ...
              <div className={styles["team-member"]}>
                <a href="https://twitter.com/kinsafemoon" target="_blank" rel="noreferrer"><img src="/deano.jpg" /></a>
                <p>
                  Deano
                  <br />
                  Lead Advisor
              ...
              <div className={styles["team-member"]}>
                <a href="https://twitter.com/Akarune_Starr" target="_blank" rel="noreferrer"><img src="/akarune.png" /></a>
                <p>
                  Akarune
                  <br />
              ...
              <div className={styles["team-member"]}>
                <a href="https://twitter.com/GroovyEnzio" target="_blank" rel="noreferrer"><img src="/groovy.gif" /></a>
                <p>
                  GroovyEnzio 🍉
                  <br />
              ...
              <div className={styles["team-member"]}>
                <a href="https://twitter.com/A7exSOL" target="_blank" rel="noreferrer"><img src="/alex.webp" /></a>
                <p>
                  Alex
                  <br />
